...
/*   Updated: 2025/11/16 17:08:11 by mgama            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
sha256hash(const uint8_t *input, size_t input_length, uint8_t output[SHA256_HASH_LENGTH])
{
	 ...
	 */
	word_t H0 = 0x6a09e667;
	word_t H1 = 0xbb67ae85;
	word_t H2 = 0x3c6ef372;
	word_t H3 = 0xa54ff53a;
	word_t H4 = 0x510e527f;
	word_t H5 = 0x9b05688c;
	word_t H6 = 0x1f83d9ab;
	word_t H7 = 0x5be0cd19;
