...
/*   Updated: 2025/11/18 14:17:19 by mgama            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int
sha384hash(const uint8_t *input, size_t input_length, uint8_t output[SHA384_HASH_LENGTH])
{
	...
	/**
	 * Initial hash values for SHA-384, as RFC 6234 specifies
	 */
	word_t H0 = 0xcbbb9d5dc1059ed8;
	word_t H1 = 0x629a292a367cd507;
	word_t H2 = 0x9159015a3070dd17;
	word_t H3 = 0x152fecd8f70e5939;
	word_t H4 = 0x67332667ffc00b31;
	word_t H5 = 0x8eb44a8768581511;
	word_t H6 = 0xdb0c2e0d64f98fa7;
	word_t H7 = 0x47b5481dbefa4fa4;
	...
	for (size_t chunk = 0; chunk < padded_input_length; chunk += CHUNK_LENGTH)
	{
		...
		/**
		 * The main loop of the SHA-384 algorithm, consisting of 64 operations.
	...
	memcpy(output, final_hash, SHA384_HASH_LENGTH);
